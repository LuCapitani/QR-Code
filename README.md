...
- Solution URL: [Github Repository](https://github.com/LuCapitani/QR-Code)
- Live Site URL: [Projeto QR Code](https://lucapitani.github.io/QR-Code/)
...
- [Google Fonts](https://fonts.google.com/specimen/Outfit) - This provided the 'Outfit' font family required for the project. The implementation was straightforward and the site offers great preview tools.
